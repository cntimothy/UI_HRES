<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckEvaluateTable.aspx.cs"
    Inherits="HRES.Pages.EvaluateTableManagement.CheckEvaluateTable" %>
...
<body>
            ...
            <x:Panel ID="Panel2" runat="server" BodyPadding="5px" ShowBorder="false" ShowHeader="false"
                ...
                <Items>
                    <x:Grid ID="Grid1" runat="server" Title="被考评人名单" Width="730px" PageSize="20" ShowBorder="true"
                        ...
                        OnPreRowDataBound="Grid1_PreRowDataBound" AllowSorting="true" SortColumnIndex="12" SortDirection="DESC" OnSort="Grid1_Sort">
                        <Columns>
    ...
    <x:Window ID="Window_CheckEvaluateTable" Title="弹出窗体" Popup="false" EnableIFrame="true"
        IFrameUrl="about:blank" EnableMaximize="true" Target="Top" EnableResize="true"
        runat="server" OnClose="Window_CheckEvaluateTable_Close" IsModal="true" CssStyle="width:80%"
        EnableConfirmOnClose="true" Height="560px" AutoHeight="true" EnableClose="false">
    </x:Window>
    </form>
</body>
</html>
